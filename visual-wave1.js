(() => {
  ...
  style.textContent = `
    ...
    #visualWave1Sidebar nav { display:grid; gap:4px; }
    #visualWave1Sidebar button { width:100%; border:0; border-radius:8px; background:transparent; color:#dce7e1; padding:11px 12px; text-align:left; font:700 12px/1.2 Manrope,system-ui,sans-serif; cursor:pointer; }
